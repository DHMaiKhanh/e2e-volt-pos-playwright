...
| 3   | [docs/features/income-daily.md](../features/income-daily.md) | →   | [docs/testcases/income-daily-testcases.md](../features/income-daily.md)            | Skill 2                 | 44 TC; tài liệu-hoá coverage đã có (không đè code)         |
