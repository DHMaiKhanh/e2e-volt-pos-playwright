...
| 4   | [docs/features/order-pending.md](../features/order-pending.md)                                                             | →   | [docs/testcases/order-pending-testcases.md](../features/order-pending.md)                                                              | Skill 2 (testcase-gen)  | 11 test case, mỗi TC map 1-1 một `test()`                                   |
| 5   | [docs/testcases/order-pending-testcases.md](../features/order-pending.md)                                                  | →   | [src/pages/pos/OrderPendingPage.ts](../../src/pages/pos/OrderPendingPage.ts)                                                           | Skill 2                 | Thêm locator toolbar + card + action (search/setSort/…)                     |
| 6   | [docs/testcases/order-pending-testcases.md](../features/order-pending.md)                                                  | →   | [tests/regression/orders/order-pending/TC-order-pending.spec.ts](../../tests/regression/orders/order-pending/TC-order-pending.spec.ts) | Skill 2                 | 11 `test()` (TC-OP-01..11)                                                  |
