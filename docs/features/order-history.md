...
> Chạy chỉ-báo-cáo (`I18N_LENIENT=1`). Bản đồ chi tiết vùng: [order-history-translation-map.md](../i18n/order-history-translation-map.md).
...
> Khớp với [order-history-translation-map.md](../i18n/order-history-translation-map.md) §3: lưới lịch + tiêu đề ngày
...
- Scan này phủ **trang chính**; các dialog phụ thuộc đơn (Hoá đơn / Hoàn tiền / Huỷ / Chỉnh tip) và lưới lịch
  đã được ghi nhận riêng trong [order-history-translation-map.md](../i18n/order-history-translation-map.md) §1c-1e, §2, §3
...
- Spec/glossary: [docs/i18n/order-history-translation-map.md](../i18n/order-history-translation-map.md) (giữ riêng)
- Luồng code-gen (tách riêng): [codegen-flow/order-history-flow.md](../codegen-flow/order-history-flow.md) · [codegen-detail/order-history-detail.md](../codegen-detail/order-history-detail.md)
