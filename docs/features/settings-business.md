...
- Spec/glossary: `../i18n/settings-business-translation-map.md` (nếu có, giữ riêng)
- Luồng code-gen (tách riêng): [../codegen-flow/settings-business-flow.md](../codegen-flow/settings-business-flow.md) · [../codegen-detail/settings-business-detail.md](../codegen-detail/settings-business-detail.md)
